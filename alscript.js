...
function add() {
  if (value != '') {
    ...
    if (curpoint >= 0 && curpoint < 1) {
      ...
      document.getElementById('curnum').innerHTML = "Press the Equals button!";
...
function equals() {
  ...
  document.getElementById('curnum').innerHTML = "‎Diameter: " + diameter;
  ...
  document.getElementById('curtex').innerHTML = "Extra Circle Numbers";
...
function epicanum() {
  ...
  document.getElementById('epic').innerHTML = "Extra Numbers:" + "<br /> <br />" + "Radius: "+ Math.round(radius*1000)/1000 +"<br />" + "Circumfrence: "+ Math.round(c*1000)/1000 +"<br />" +"Area: " + Math.round(area *1000)/1000
